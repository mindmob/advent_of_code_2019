...
func main() {
	...
	intersections := Intersections(wires1, wires2)
	closest := FindShortestVector(intersections)
	distance := ManhattanDistance(closest)
	fmt.Println("Nearest intersection: ", distance)
